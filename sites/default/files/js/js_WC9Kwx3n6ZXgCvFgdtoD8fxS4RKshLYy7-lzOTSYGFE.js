$(document).ready(function() {
    ...
    $('.blog .blocks .bg').equalHeights({});


    $('.top-viewed-blogs .bg').equalHeights({});

    $('.blog-inner .bg-col').equalHeights({});

    $('.why-work .bg').equalHeights({});

    $('.overview-tabs .bg').equalHeights({});
...
$(document).ready(function() {
    ...
    $("#project-slider-inner").owlCarousel({
        autoPlay: false,
        center: true,
        touchDrag: true,
        mouseDrag: true,
    ...
    $("#projects-slider-year").owlCarousel({
        autoPlay: false,
        touchDrag: true,
        mouseDrag: true,
        loop: true,
    ...
    $("#life-aparna-slider").owlCarousel({
        autoPlay: false,
        touchDrag: true,
        mouseDrag: true,
        loop: true,
